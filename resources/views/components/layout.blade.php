                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            @auth
                                ...
                                <a href="{{ route('customers.index') }}"
                                    class="{{ request()->is('customers') ? 'bg-green-800 text-white' : 'text-gray-300 hover:bg-green-700 hover:text-white' }} block rounded-md px-3 py-2 text-base font-medium">Customers
                                    Management</a>
